...
def positions_of(geom, /):
    ...
    geometry's data lives at its coordinates. A grid's lives at the center of
    ...
    array-like
        ...
        grid's cell centers, or a prism mesh's two surfaces.
    ...
    if isinstance(geom, Grid):
        ...
        # lives, at the centers the affine takes the integer indices to.
